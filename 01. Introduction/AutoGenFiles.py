...
with open(r'C:\Users\sunil\Desktop\GFG\01. Introduction\QuestionList.txt', 'r') as file:
...
for name in filenames:
    ...
    filepath = os.path.join(r'C:\Users\sunil\Desktop\GFG\01. Introduction', filename)
